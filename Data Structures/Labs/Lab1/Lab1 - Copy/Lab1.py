...
def process_files(input):
    ...
    for i in input:
        postfixoutput, postfixerrors = postfix(i)  # Call postfix function and receive two values
        output.append(postfixoutput)
        postfixerrortotal += postfixerrors  # Update error count
    return output, postfixerrortotal
